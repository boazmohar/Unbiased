function GetMasks_par_files_v4(ch_names_type)
...
coder.extrinsic('sort_nat')
coder.extrinsic('filesep')
coder.extrinsic('dir')
baseDir = pwd();
switch ch_names_type
    case 1
...
parfor i =1:numFiles
    ...
    for ch = 1: length(ch_names)
        ch_name = ch_names{ch};
        curernt_ch = imread([baseDir filesep 'raw' filesep ...
