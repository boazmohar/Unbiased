...
export_fig 'figure1_C_newLUT.eps' -depsc
...
start_x = x1 - y_lim(1);
start_y = y1 - x_lim(1);
arrow_x = [0.188235294117647,0.208823529411765];
arrow_y = [0.441970822281167,0.387267904509284];
...
export_fig 'figure1_B_newLUT.eps' -depsc
