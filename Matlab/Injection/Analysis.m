...
text(170,105,sprintf('%.1fAU/min', slopes(1)*60),'color',h1(1).Color)
text(170,125,sprintf('%.1fAU/min', slopes(2)*60),'color',h2(1).Color)
xlabel('Time (s)');
ylabel('F (AU)');
ylim([100, 150])
legend({'20ul/min','40ul/min'}, 'box','off', 'location','northwest');
box off
f = figure(7);
clf
f.Units = 'centimeters';
...
box off
text(60,103,sprintf('%.1fAU/min', slopes(3)*60),'color',h1(1).Color)
text(60,118,sprintf('%.1fAU/min', slopes(4)*60),'color',h2(1).Color)
text(60,131,sprintf('%.1fAU/min', slopes(5)*60),'color',h3(1).Color)
xlabel('Time (s)');
ylabel('F (AU)');
ylim([100, 150])
legend({'20ul/min','40ul/min', '80ul/min'}, 'box','off', 'location','northwest');